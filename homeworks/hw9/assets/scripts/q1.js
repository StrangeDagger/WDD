...
function setBackgroundColor(color) {
    ...
    let buttonElement = document.getElementById("q1-container");
...
document.getElementById("q1-btn-lightblue").onclick = blueButtonClicked;
...
document.getElementById("q1-btn-blue").onclick = blackButtonClicked;
